...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "template_news_list"
	),
	false
);?> <br>
 <br>
...
<div class="site-section site-section-sm bg-light">
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"DETAIL_URL" => "",
		"FIELD_CODE" => array("PREVIEW_TEXT","PREVIEW_PICTURE","PROPERTY_PRICE","PROPERTY_TOTAL_AREA","PROPERTY_NUMBER_OF_FLOORS","PROPERTY_BATHROOMS","PROPERTY_GARAGE",""),
		"IBLOCKS" => array("2"),
		"IBLOCK_TYPE" => "ads",
		"NEWS_COUNT" => "6",
		"PROPERTY_CODE" => "",
...
<div class="site-section">
	...
	Array(
		...
		"DETAIL_URL" => "",
		"FIELD_CODE" => array(0=>"PROPERTY_LINK",1=>"PROPERTY_ICON",),
		"IBLOCKS" => array(0=>"7",),
		"IBLOCK_TYPE" => "service",
		"NEWS_COUNT" => "6",
		"SORT_BY1" => "ACTIVE_FROM",
