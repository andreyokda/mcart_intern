					...
					<div class="container">
						<div class="row gy-4">
							<?php foreach ($arResult['ITEMS'] as $item):
								...
								$uniqueId = $this->GetEditAreaId($item['ID']);
								...
								} elseif (is_array($item['DETAIL_PICTURE']) && $item['DETAIL_PICTURE'] > 0) {
									$image = CFile::GetFileArray($item['DETAIL_PICTURE']);
								}
								
								if (!empty($image['ALT'])) $alt = htmlspecialcharsbx($image['ALT']);
								if (!empty($image['TITLE'])) $title = htmlspecialcharsbx($image['TITLE']);
								
								$src = !empty($image['SRC']) ? $image['SRC'] : $this->GetFolder().'/images/no-photo.jpg';
						?>
								<div class="col-lg-4" id="<?=$uniqueId?>">
									<article>
										<div class="post-img">
										...
										<div class="card-body">
											...
											<?php if ($item['PREVIEW_TEXT']): ?>
												<p class="card-text"><?=TruncateText($item['PREVIEW_TEXT'], 100)?></p>
											<?php endif; ?>
